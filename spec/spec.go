...
// and the media types. Framework-free: no imports.
package spec
...
// StatusList/TTL are the draft's private CWT claim keys ([Token Status List §5.2] / IANA CWT Claims).
const (
	ClaimSub        int64 = 2
	ClaimExp        int64 = 4
	ClaimIat        int64 = 6
...
// Registered status values ([Token Status List §7]).
const (
